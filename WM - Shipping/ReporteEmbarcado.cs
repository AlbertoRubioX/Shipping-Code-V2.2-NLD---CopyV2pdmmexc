...
{
    public partial class ReporteEmbarcado : Form
    {
        ...
        string FechaInicial;
        string FechaFinal;
        const string TituloArchivo = "REPORTE DE GENERAL DE EMBARCADO";

        public ReporteEmbarcado()
        {
            InitializeComponent();
        }
        ...
        private void bgwCrearExcel_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            Archivo.CrearArchivoExcel("General -" + Fecha.Trim(), dtinfo, "REPORTE DE GENERAL DE EMBARCADO", bgwCrearExcel);
        }
        ...
        {
            dtvResultado.DataSource = Consultar.ShipReportEmbarcado(GlobalVar.Compania, FechaInicial.Trim(), FechaFinal.Trim());
            dtinfo = Consultar.ShipReportEmbarcado(GlobalVar.Compania, FechaInicial.Trim(), FechaFinal.Trim());
        ...
        private void ReporteEmbarcado_Load(object sender, EventArgs e)
        {
